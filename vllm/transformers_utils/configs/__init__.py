...
_CLASS_TO_MODULE: dict[str, str] = {
    ...
    "DiffusionGemmaConfig": "vllm.transformers_utils.configs.diffusion_gemma4",
    "DiffusionGemmaTextConfig": "vllm.transformers_utils.configs.diffusion_gemma4",
    # TODO(diffusion): remove "...4" aliases once checkpoints finalize to RC0.1.
    "DiffusionGemma4Config": "vllm.transformers_utils.configs.diffusion_gemma4",
    "DiffusionGemma4TextConfig": "vllm.transformers_utils.configs.diffusion_gemma4",
